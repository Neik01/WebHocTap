<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllCourses.aspx.cs" Inherits="WebHocTap.AllCourses" %>
...
<body>
   <div class="header">
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="AllCourses.aspx"><strong>Tất cả khóa học</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="all" runat="server">
                    <ItemTemplate>
