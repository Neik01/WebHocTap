<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Languages.aspx.cs" Inherits="WebHocTap.Languages" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Toàn bộ khóa học</title>
...
<body>
   <div class="header">
    ...
    <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Languages.aspx"><strong>Khóa học ngoại ngữ</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="languages" runat="server">
                    <ItemTemplate>
